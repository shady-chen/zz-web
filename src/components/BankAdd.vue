 ...
 background: #f6f6f6" >
          ...
          <p style="text-align: left!important;margin-bottom: 15px;">
            <span style="font-size: 0.3rem;color: #000;">银行卡类型：
              <!--{{bankData.bank_which}}-->
              <input type="text" name="remark" style="width: 260px;height:  0.5rem;margin-top: 3px" v-model="bank_which" />
          ...
          <p style="text-align: left!important;margin-bottom: 15px;">
            <span style="font-size: 0.3rem;color: #000;">开户行：
              <!--{{bankData.bank_which}}-->
              <input type="text" name="remark" style="width: 280px;height:  0.5rem;margin-top: 3px" v-model="bank_where" />
